...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nskeyedunarchiver-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14053&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nskeyedunarchiver-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nskeyedunarchiver` can be installed with:

```
conda install nskeyedunarchiver
```

It is possible to list all of the versions of `nskeyedunarchiver` available on your platform with:
